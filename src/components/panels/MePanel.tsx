...
export function MePanel({ enabled }: IPanel) {
  ...
  const SELF_INTRO = `${"\n"}Thanks for visiting my page!
    ...
    ${"\n"}I’m currently a 4rd year student (4A) at the University of Waterloo majoring in Computational Mathematics with minors in Computing and Combinatorics & Optimization. 
    ${"\n"}Current main hobbies/focus: working out, drawing, bouldering, and working on refern. (check it out in project section!) ${"\n"}Want to (in the future): learn piano/guitar, learn singing, learn dancing, and produce music
