...
export function WorksPanel({ enabled }: IPanel) {
    ...
    projects: [
      {
        ...
        linkedIcon: {
          link: "https://github.com/jaks024/refern-client",
          imageSrc: githubIcon,
          alt: "https://github.com/jaks024/refern-client",
      ...
      },
      {
        name: "ExpV2",
        description:
          "Simplified and redesigned personal monthly income & expense manager with Google Cloud integration (Mflow successor)",
        techStack: {
          techs: [
            "React",
            "TypeScript",
      ...
      },
      {
        ...
        techStack: {
          techs: ["Express", "TypeScript", "Docker", "Google Cloud Run"],
        },
        linkedIcon: {
      ...
      },
      {
        ...
        description:
          "Electron desktop app to amass, view, and organize tweet media attachments from multiple Twitter users",
        techStack: {
      ...
      },
      {
        name: "my-todo-list",
        description:
          "Implementation of Google Calendar day view as a to-do list with scalable UI based on time",
        techStack: {
      ...
      },
      {
        ...
        description:
          "A music organizer and player to aggregate and play songs from the rhythm game called osu!.",
        techStack: {
          techs: ["WPF", "C#", "CSCore"],
        },
        linkedIcon: {
      ...
      },
      {
        ...
        description:
          "Versus your friends online in a head to head classic Minesweeper battle for the fastest clear time.",
        techStack: {
          techs: ["Unity", "C#", "Pun"],
        },
        linkedIcon: {
      ...
      },
      {
        name: "My Watch List",
        description:
          "An Android app that allows you to keep track of your entertainment (1500+ downloads on Google Play Store).",
        techStack: {
  ...
  return (
    <div
      className={
        "work-panel panel " + (enabled ? "panel-enabled" : "panel-disabled")
      }
    >
